...
<head>
    ...
    @vite(['resources/css/addCar.css','resources/js/editCar.js'])
    ...
    <div style="min-height: 100%; padding: 40px 20px;">
        <div class="text-center mb-12 fade-in mt-12">
            ...
            <p style="font-size: 18px; color: var(--text-secondary); margin: 0; font-weight: 400;">
                change a fild and submit to update.
            </p>
        </div>
        {{-- <!-- Progress Steps -->
        ...
        <div class="glass-panel max-w-4xl mx-auto p-8 fade-in" style="animation-delay: 0.4s; border: 2px solid rgba(245, 184, 0, 0.2);">
            <form id="carForm" action="/car/edit/{{ $car->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-step active" id="formStep1">
                    ...
                    <div class="slide-up" style="animation-delay:0.1s;">
                        <div class="upload-area" id="uploadArea" onclick="document.getElementById('fileInput').click()">
                            <h3>Upload Car Images to Update The Current Car Image</h3>
                            <p>Drag and drop images here, or click to browse</p>
                        </div>
                        <input type="file" id="fileInput" name="images" style="display:none;" onchange="handleFileSelect(event)">
                    ...
                    <div class="form-grid grid grid-cols-1 md:grid-cols-2 gap-6 slide-up" style="animation-delay:0.1s;">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                    id="carName" 
                                    name="carName" 
                                    class="form-input" value="{{ $car->name }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   name="pricePerDay" 
                                   class="form-input" 
                                   value="{{ $car->price_per_day }}" min="1" required>
                    ...
                    <div class="form-grid grid grid-cols-1 md:grid-cols-2 gap-6 slide-up" style="animation-delay:0.1s;">
                        <div class="form-group">
                            ...
                            <select id="seats" name="seats" class="form-select" required>
                                <option value="{{$car->seats}}">{{$car->seats}} seats</option>
                    ...
                    <div class="form-group slide-up" style="animation-delay:0.2s;">
                        ...
                        <textarea id="description" name="description" class="form-textarea" placeholder="Describe your car's condition, special features, and any important details for renters..." required>{{ $car->description}}</textarea>
                        <x-input-error :messages="$errors->get('description')" class="mt-2" />
                    </div>

                    {{-- submit button --}}
                    <div class="flex justify-between mt-8">
                        <button type="button" class="btn-secondary" onclick="window.location='/owner'">cancel</button>
                        <button type="submit" class="btn-primary">
                            <span id="submitText">update My Car</span>
                        </button>
                    </div>
