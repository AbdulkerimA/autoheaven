...
<html lang="en" class="dark">
 <head>
  ...
  <title>Auto Heaven - Sign Up</title>
 ...
 <body class="font-body bg-dark-bg light:bg-light-bg text-dark-text light:text-light-text transition-all duration-500 min-h-screen"><!-- Theme Toggle - Fixed Position -->
   ...
   <div class="hidden lg:flex lg:w-1/3 overflow-hidden sticky top-10 left-0">
    ...
    <div class="relative z-10 flex flex-col justify-center items-center text-center px-6 text-white"><!-- Logo -->
     ...
     <div class="animate-fade-up" style="animation-delay: 0.2s;">
      <h2 class="text-4xl md:text-5xl font-heading font-bold mb-6 leading-tight">Join Auto Heaven —<br><span class="bg-gradient-to-r from-accent to-warm-amber bg-clip-text text-transparent">Drive Your Dream.</span></h2>
      <p class="text-xl text-white/80 max-w-md mx-auto font-body">Join thousands of car owners who are earning extra income by sharing their vehicles with our premium community.</p>
     </div>
    </div>
   </div><!-- Right Section - Login Form -->
    ...
    <div class="w-full max-w-md"><!-- Mobile Logo (visible on small screens) -->
     ...
     <div class="login-card golden-glow p-8 rounded-xl animate-fade-up" style="animation-delay: 0.1s;"><!-- Header -->
      <div class="text-center mb-8">
       <h2 class="text-3xl font-heading font-bold mb-2 text-dark-text light:text-light-text">Create Account</h2>
       <p class="text-gray-400 light:text-gray-600 font-body">Join Auto Heaven and start your journey</p>
      </div><!-- Sign Up Form -->
      <form class="space-y-6" id="signupForm"><!-- Full Name Field -->
       <div><label for="fullName" class="block text-sm font-medium mb-2 text-dark-text light:text-light-text font-body"> Full Name </label> <input type="text" id="fullName" name="fullName" class="input-field w-full px-4 py-3 rounded-xl text-dark-text light:text-light-text placeholder-gray-400 font-body focus:outline-none" placeholder="Enter your full name" required>
       </div><!-- Email Field -->
       ...
       <div><label for="password" class="block text-sm font-medium mb-2 text-dark-text light:text-light-text font-body"> Password </label> <input type="password" id="password" name="password" class="input-field w-full px-4 py-3 rounded-xl text-dark-text light:text-light-text placeholder-gray-400 font-body focus:outline-none" placeholder="Create a password" required>
       </div><!-- Confirm Password Field -->
       <div><label for="confirmPassword" class="block text-sm font-medium mb-2 text-dark-text light:text-light-text font-body"> Confirm Password </label> <input type="password" id="confirmPassword" name="confirmPassword" class="input-field w-full px-4 py-3 rounded-xl text-dark-text light:text-light-text placeholder-gray-400 font-body focus:outline-none" placeholder="Confirm your password" required>
       </div><!-- Terms Agreement -->
       <div class="flex items-start"><input type="checkbox" id="terms" class="w-4 h-4 text-accent bg-transparent border-gray-400 rounded focus:ring-accent focus:ring-2 mt-1"> <label for="terms" class="ml-3 text-sm text-gray-400 light:text-gray-600 font-body"> I agree to the <a href="#terms" class="text-accent hover:text-warm-amber transition-colors duration-300">Terms of Service</a> and <a href="#privacy" class="text-accent hover:text-warm-amber transition-colors duration-300">Privacy Policy</a> </label>
       </div><!-- Sign Up Button --> 
        <button 
            onclick="window.location = '/profile/create'" 
            type="submit" class="btn-primary w-full py-3 rounded-xl font-bold text-lg font-heading"> Create Account </button>
      </form><!-- Divider -->
      <div class="my-8 flex items-center">
       <div class="flex-1 border-t border-gray-600 light:border-gray-300"></div><span class="px-4 text-sm text-gray-400 light:text-gray-600 font-body">Or sign up with</span>
      ...
      <div class="mt-8 text-center">
       <p class="text-sm text-gray-400 light:text-gray-600 font-body">Already have an account? <a href="/login" class="text-accent hover:text-warm-amber transition-colors duration-300 font-medium">Login</a></p>
       <p class="text-xs text-gray-500 light:text-gray-500 mt-4 font-body">© 2025 Auto Heaven. All rights reserved.</p>
      </div>
     </div>
    </div>
   </div>
  ...
  <script>
        ...
        document.getElementById('signupForm').addEventListener('submit', function(e) {
            ...
            if (!termsAccepted) {
                showModal('Terms Required', 'Please accept the Terms of Service and Privacy Policy to continue.');
                return;
            }
            
            showModal('Account Created', `Welcome to Auto Heaven, ${fullName}! Your account has been created successfully.`);
        });
        ...
        document.querySelectorAll('a[href="#terms"]').forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault();
                showModal('Terms of Service', 'Terms of Service document will be displayed here.');
            });
        });
        ...
        document.querySelectorAll('a[href="#privacy"]').forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault();
                showModal('Privacy Policy', 'Privacy Policy document will be displayed here.');
            });
        });
        ...
        document.querySelectorAll('a[href="#login"]').forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault();
                showModal('Login', 'Redirecting to login page...');
            });
        });
    </script>
  <script>
 ...
 <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9962199924a45451',t:'MTc2MTczNDkwMC4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>